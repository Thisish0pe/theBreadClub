...
## 5. 실행화면
### 유저 권한 및 로그인
![무제](https://github.com/Thisish0pe/theBreadClub/assets/130428546/aeb27ebe-7330-454d-9965-d2e4864f118d)
### 댓글 CRUD

### 게시글 작성

### 게시글 수정
![무제 4](https://github.com/Thisish0pe/theBreadClub/assets/130428546/df94bd30-08a2-4642-8ee7-ba00941be52f)

### 게시글 검색
![무제 5](https://github.com/Thisish0pe/theBreadClub/assets/130428546/1a4f0a77-ca7f-4bcb-ab34-794a702eef16)

## 6. AWS lightsail 배포
### 6-1. URL : http://43.202.89.186:8000/
### 6-2. 배포 중 깨달은 것
* 터미널을 끈 상태에서도 서버가 실행되게 하려는 경우, 백그라운드 모드로 실행해야합니다. 백그라운드 모드는 nohup을 이용해서 실행하는 방법, screen, tmux를 이용해서 실행하는 방법 이렇게 두 가지가 있습니다. nohup 을 이용하여 백그라운드 모드 실행하였습니다.
* `nohup python manage.py runserver 0.0.0.0:800 &` 와 같이 nohup과 &을 붙여서 실행합니다.
* 중시 시킬 경우, `ps -ef|grep runserver`명령으로 실행프로세스 ID 찾은 후, `kill-9 프로세스 ID` 를 입력하면 됩니다.
